...
# plt.axis("off")     
# plt.savefig('{}/simple_graph.png'.format(plot_path), bbox_inches='tight') 
...
# plt.axis("off")     
# plt.savefig('{}/simple_graph_fixed.png'.format(plot_path), bbox_inches='tight')
...
# plt.axis("off")     
# plt.savefig('{}/simple_graph_edge_only.png'.format(plot_path), bbox_inches='tight') 

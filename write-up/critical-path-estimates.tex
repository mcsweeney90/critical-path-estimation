...
% maybe elaborate further (depending on what I eventually decide to include).
...
\begin{itemize}
	\item Largely supporting previous investigations along these lines \cite{zhao03}, perhaps our biggest takeaway is that no method appears to be dominant and it is impossible to say, for a given DAG and target platform, which should be used. 

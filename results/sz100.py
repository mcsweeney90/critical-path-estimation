...
# -*- coding: utf-8 -*-
"""
Script to run comparison of modified HEFT and PEFT heuristics for size 100 DAGs from the STG.
"""
...
with open("sz100_timing.txt", "w") as dest:
            ...
            for b in ccrs:
                for h in het_factors:
                    for _ in range(5):
                        ...
                        for rk in rks:
                            if q == 16 and (rk == "F" or rk == "WF"):
                                continue    # Benchmarking suggest F and WF too expensive with q == 16.
...
# Save the info dict.
with open('sz100_info.dill', 'wb') as handle:
